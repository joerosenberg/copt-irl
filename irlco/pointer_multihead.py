...
from torch.nn.functional import softmax, dropout, linear, pad
...
def multi_head_attention_forward(query,                           # type: Tensor
    ...
    if need_weights:
        ...
        return attn_output, attn_output_scores.sum(dim=1) / num_heads
    else:
        return attn_output, None


class PointerMultiheadAttention(Module):
    ...
    def __setstate__(self, state):
        ...
        super(PointerMultiheadAttention, self).__setstate__(state)
